...
rows = [
    ...
    line_kv("Focus", "consumer AI, habit change, voice"),
    None,
    header("- MyFutureSelf"),
    line_kv2("Downloads", "40k+", None, "Paid Users", "2.5k+", None),
    line_kv2("ARR", "$109k+", None, "Growth", "52% avg monthly", None),
    line_kv("App Store", "4.7 stars (909 reviews)"),
    None,
    header("- Contact"),
